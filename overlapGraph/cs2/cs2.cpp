...
#ifdef PRINT_ANS
void print_solution(node *ndp, arc *arp, long nmin, double *cost, const char *filename)
{
  node *i;
  arc *a;
  long ni;
...
double main_cs2(const char *input_filename, const char *output_filename)//int argc, char **argv)
{
  //int *solution;
