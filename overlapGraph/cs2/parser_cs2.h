...
int parse(long *n_ad, long *m_ad, node **nodes_ad, 
	  ...
	  long **cap_ad, const char *filename )
...
node    *nodes = NULL,                 /* pointers to the node structure */
        *head_p,
        *ndp,
        *in,
        *jn;

arc     *arcs = NULL,                  /* pointers to the arc structure */
        *arc_current = NULL,
        *arc_new,
        *arc_tmp;
...
price_t cost,                   /* arc cost */
        m_c = 0;                    /* maximum arc cost */

long    *cap = NULL;                   /* array of capacities */

excess_t total_p = 0,                /* total supply */
        total_n = 0,                /* total demand */
